...
namespace Tests\Vendor\Normalizer;
...
use Tests\Vendor\Fixtures\Dummy;
use Tests\Vendor\Fixtures\GroupDummy;
use Tests\Vendor\Fixtures\GroupDummyChild;
use Tests\Vendor\Fixtures\PropertyCircularReferenceDummy;
use Tests\Vendor\Fixtures\PropertyNormalizer;
use Tests\Vendor\Fixtures\PropertySiblingHolder;
use Tests\Vendor\Normalizer\Features\CallbacksTestTrait;
use Tests\Vendor\Normalizer\Features\CircularReferenceTestTrait;
use Tests\Vendor\Normalizer\Features\ConstructorArgumentsTestTrait;
use Tests\Vendor\Normalizer\Features\GroupsTestTrait;
use Tests\Vendor\Normalizer\Features\IgnoredAttributesTestTrait;
use Tests\Vendor\Normalizer\Features\MaxDepthTestTrait;
use Tests\Vendor\Normalizer\Features\ObjectToPopulateTestTrait;
use Tests\Vendor\Normalizer\Features\TypeEnforcementTestTrait;
